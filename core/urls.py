...
urlpatterns = [
    ...
    path("admin/surveys/<int:pk>/close-now/", admin_survey_close_now, name="admin_survey_close_now"),
    path("admin/surveys/<int:pk>/votes/", admin_survey_votes, name="admin_survey_votes"),
